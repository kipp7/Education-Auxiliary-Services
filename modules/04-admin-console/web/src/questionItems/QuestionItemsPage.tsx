    ...
    <div className="container">
      ...
      <div className="card">
        ...
        <div className="row">
          ...
          <select className="input" style={{ width: 140 }} value={type} onChange={(e) => setType(e.target.value as QuestionItemType | "ALL")}>
                ...
                <div className="row" style={{ alignItems: "flex-start" }}>
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (unit === null) return;
                      const type = (prompt("题型（SINGLE/MULTI/JUDGE/FILL/SHORT）", x.type) ?? x.type) as QuestionItemType;
