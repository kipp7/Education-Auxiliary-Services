    ...
    actions: {
      ...
      renameUser(id: string, displayName: string) {
        ...
        setAndPersist({
          users: state.users.map((u) =>
            u.id === id ? { ...u, displayName: displayName.trim() || u.displayName, updatedAt: now } : u,
          ),
        });
      },
      ...
      toggleStatus(id: string) {
        ...
        setAndPersist({
          users: state.users.map((u) =>
            u.id === id
              ? { ...u, status: u.status === "ACTIVE" ? "DISABLED" : "ACTIVE", updatedAt: now }
              : u,
          ),
        });
      },
          ...
          users: state.users.map((u) =>
            u.id === id
              ? {
                  ...
                  updatedAt: now,
                  bindings: [
                    { id: newId("bind"), code, redeemedAt, validUntil },
                    ...u.bindings,
                  ],
                }
              : u,
